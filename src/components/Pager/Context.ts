...
import { PagerContextProps, PagerContextRenderProps } from './types'

const PagerContext = Generator<PagerContextProps, PagerContextRenderProps>(
  ({
    page=0,
    pages,
    buttonClass='outline',
...
export const usePager = PagerContext.Use
