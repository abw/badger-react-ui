  ...
  <div className="flow">
    ...
    <DescTable
      items={[
        ...
        ['CheckboxInput', '`Checkbox` input component from badger-form'],
        ['HiddenInput',   '`Hidden` input component from badger-form'],
        ['RadioInput',    '`Radio` input component from badger-form'],
        ['SelectInput',   '`Select` input component from badger-form'],
        ['TextInput',     '`Text` input component from badger-form'],
        ['TextAreaInput', '`TextArea` input component from badger-form'],
