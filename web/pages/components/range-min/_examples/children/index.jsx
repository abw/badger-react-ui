...
const RangeExample = () =>
  ...
  >
    ...
    <p>
      Inside the scope of the <code>RangeMin</code> element, any children can
      access the context using the <code>useRange</code> hook.  Immediate
      children of the <code>RangeMin</code> component can also be functions
    ...
    <p>
      ...
      Then we include several copies of the custom <code>SetMin</code> component (lines 13-17)
      which uses the <code>useRange</code> hook to access the{' '}
      <code>setMinValue</code> function (line 39).
    </p>
    <p>
      The final block of code (lines 19 to 35) demonstrates a function which receives the{' '}
      <code>setMinValue</code> function as a property which it can then call
      directly.
    </p>
  </Example>
